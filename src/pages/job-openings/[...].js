...
var _jobFile;
var jobtital="";
function ProductCatchAll({ serverData }) {
  const job = serverData?.jobdata;
  var jobtital=serverData?.jobdata?.heading;
...
export async function getServerData(context) {
  ...
  try {
    ...
    const jobdata = await fetch(`${process.env.GATSBY_API_URL}job-openings/${context.params['*']}`);
